                            ...
                            <flux:button.group>
                                @can('view', $employee)
                                    <flux:button href="{{ route('employees.show', $employee) }}" variant="ghost"
                                        size="sm" title="Ver" wire:navigate>
                                ...
                                @can('update', $employee)
                                    <flux:button href="{{ route('employees.edit', $employee) }}" variant="ghost"
                                        size="sm" title="Editar" wire:navigate>
                ...
                @empty
                    <flux:table.row>
                        <flux:table.cell colspan="7" class="text-center py-10">
                            <flux:text size="sm" class="text-zinc-500 italic">No se encontraron empleados con esos criterios.</flux:text>
                        </flux:table.cell>
                    </flux:table.row>
                @endforelse
            </flux:table.rows>
